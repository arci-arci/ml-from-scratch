...
The data used during clustering is the output of the [Run-length encoding](https://en.wikipedia.org/wiki/Run-length_encoding) algorithm over the entire Frankenstein book's first chapter. [Project Gutenberg](https://www.gutenberg.org/).
